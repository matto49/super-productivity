...
export enum IPC {
  ...
  UPDATE_TASK_WIDGET_LIST = 'UPDATE_TASK_WIDGET_LIST',
  TASK_WIDGET_WRITE = 'TASK_WIDGET_WRITE',
  TASK_WIDGET_PROGRESS = 'TASK_WIDGET_PROGRESS',
  TASK_WIDGET_ACTION = 'TASK_WIDGET_ACTION',
  TASK_WIDGET_COMPLETE = 'TASK_WIDGET_COMPLETE',
